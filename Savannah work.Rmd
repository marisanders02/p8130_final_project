...
reading_without_interactions <- lm(reading_score ~ gender + ethnic_group + parent_educ +     lunch_type + test_prep + parent_marital_status + practice_sport +    is_first_child + transport_means + wkly_study_hours + reading_score + math_score + gender:writing_score + gender:math_score + ethnic_group:transport_means +     ethnic_group:writing_score + parent_educ:math_score +   lunch_type:wkly_study_hours + 
